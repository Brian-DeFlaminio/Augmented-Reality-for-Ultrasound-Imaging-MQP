...
private:
    ...
    void rawData(int sz);
///////MY STUFF
    void downloadImages(const void* img, int w, int h, int bpp, int sz); ///here
    void sendImageToUnity(const void* img, int w, int h, int bpp, int sz);
    void sendToPersistentPath(const void* img, int w, int h);
